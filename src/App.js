...
import heartt from "./Images/user_image_frame_1.png"
import circle from "./Images/user_image_frame_3.png"
import rect from "./Images/user_image_frame_4.png"
...
function App() {
  ...
  zoom={zoom}
  rotation={rotation}
  aspect={cropShape === 'square' ? 1 : undefined} // Set aspect ratio only for square shape
  cropShape={cropShape === 'rect' ? 'rect' : 'rect'} // Make sure to update this if 'square' is added
...
/>
          ...
          {cropShape === 'round' && <div className="round-shape-overlay"></div>}
        </div>
      )}
      {!finalImage && selectedImage && (
        <div className="controls-container">
          ...
          <button onClick={() => setCropShape('rect')}><img src={rect} width="18" height="20"  alt="Heart" /></button>
          <button onClick={() => setCropShape('square')}><img src={square} width="18" height="20"  alt="Heart" /></button>
          <button onClick={() => setCropShape('heart')}><img src={heartt} width="18" height="20"  alt="Heart" /></button>
          <button onClick={() => setCropShape('round')}><img src={circle} width="18" height="20"  alt="Heart" /></button>
